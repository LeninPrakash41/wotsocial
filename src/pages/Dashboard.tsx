...
import { 
  ArrowRight, Calendar, PenTool, Settings, BarChart3, TrendingUp, Bot, Sparkles, Bookmark, Film, Folder, Layers, Globe, ShieldCheck, Megaphone, Instagram, MessageSquare 
} from 'lucide-react';
      ...
      {!brand ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 space-y-6">
            ...
            {/* Multi-Channel Quick Links Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link to="/instagram-marketing" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-pink-600/40 transition-colors group">
                ...
                <h3 className="text-xs font-bold text-gray-900 mb-1">Instagram Studio</h3>
                <p className="text-[10px] text-gray-500 leading-snug">Reels & DM automation.</p>
              </Link>
              ...
              <Link to="/whatsapp-marketing" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-emerald-600/40 transition-colors group">
                ...
                <h3 className="text-xs font-bold text-gray-900 mb-1">WhatsApp Business</h3>
                <p className="text-[10px] text-gray-500 leading-snug">Broadcast & HSM messages.</p>
              </Link>
