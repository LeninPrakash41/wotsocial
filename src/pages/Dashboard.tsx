          ...
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
              ...
              <Link to="/instagram-marketing" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-pink-600/40 transition-colors group">
                <div className="w-9 h-9 bg-pink-50 text-pink-600 rounded-xl flex items-center justify-center mb-2.5 group-hover:bg-pink-600 group-hover:text-white transition-colors">
                  <Instagram className="w-4 h-4" />
                </div>
                <h3 className="text-xs font-bold text-gray-900 mb-1">Instagram</h3>
                <p className="text-[10px] text-gray-500 leading-snug">Reels & DMs.</p>
              </Link>

              <Link to="/whatsapp-marketing" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-emerald-600/40 transition-colors group">
                <div className="w-9 h-9 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-2.5 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  <MessageSquare className="w-4 h-4" />
                </div>
                <h3 className="text-xs font-bold text-gray-900 mb-1">WhatsApp</h3>
                <p className="text-[10px] text-gray-500 leading-snug">HSM broadcasts.</p>
              </Link>

              <Link to="/mcp-connector" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-orange-600/40 transition-colors group">
                <div className="w-9 h-9 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center mb-2.5 group-hover:bg-orange-600 group-hover:text-white transition-colors">
                  <Cpu className="w-4 h-4" />
                </div>
                <h3 className="text-xs font-bold text-gray-900 mb-1">Claude MCP</h3>
                <p className="text-[10px] text-gray-500 leading-snug">Claude image ingest.</p>
              </Link>
              ...
              <Link to="/schedule" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:border-black/30 transition-colors group">
                ...
                <h3 className="text-xs font-bold text-gray-900 mb-1">Schedule</h3>
                <p className="text-[10px] text-gray-500 leading-snug">Calendar grid.</p>
              </Link>
            </div>
