...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f4] text-[#0a0a0a] font-sans selection:bg-ink selection:text-white">
      {/* Header */}
        ...
        <nav className="flex items-center gap-4">
          {user ? (
            ...
            <button 
              ...
              className="px-4 py-2 bg-ink text-white text-sm font-medium rounded-lg hover:bg-ink-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      {error && (
        <div className="bg-danger-soft border-b border-danger-line px-6 py-3">
      ...
      <main className="max-w-6xl mx-auto px-6 py-24 md:py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-6xl md:text-7xl font-semibold tracking-tighter leading-[0.9]">
              Your brand's <br/>
              <span className="text-ink-3">AI social team.</span>
            </h1>
            <p className="text-lg text-ink-3 max-w-md leading-relaxed">
            ...
            <div className="flex items-center gap-4">
              {user ? (
                <Link 
                  to="/dashboard"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-ink text-white font-medium rounded-xl hover:bg-ink-2 transition-colors"
                >
                ...
                <button 
                  onClick={handleLogin}
                  disabled={isLoggingIn}
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-ink text-white font-medium rounded-xl hover:bg-ink-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoggingIn ? (
                    <>Signing In... <div className="w-4 h-4 border-2 border-surface border-t-transparent rounded-full animate-spin"></div></>
                  ) : (
          ...
          <div className="relative">
            <div className="aspect-square bg-sunk rounded-3xl shadow-lg border border-ink/5 relative overflow-hidden group">
              {/* Background Image */}
              <img 
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between">
                <div className="space-y-4 relative z-10 self-end">
                  <div className="flex items-center gap-3 bg-surface/95 backdrop-blur-sm p-3 rounded-2xl shadow-lg border border-surface/20 transform translate-x-4">
                    <div className="w-10 h-10 bg-ok-soft rounded-full flex items-center justify-center">
                      <Sparkles className="w-5 h-5 text-ok" />
                    </div>
                    <div className="pr-4">
                      <div className="text-sm font-bold text-ink">Brand Analysis Complete</div>
                      <div className="text-xs text-ink-3">Tone: Professional, Witty</div>
                    </div>
                  </div>
                </div>

                <div className="space-y-3 relative z-10 self-start w-3/4">
                  <div className="bg-surface/95 backdrop-blur-sm rounded-2xl border border-surface/20 p-5 shadow-xl transform -translate-x-4">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-6 h-6 bg-accent-soft rounded-full flex items-center justify-center">
                        <TrendingUp className="w-3 h-3 text-accent" />
                      </div>
                      <span className="text-xs font-bold text-accent uppercase tracking-wider">Trending Now</span>
                    </div>
                    <div className="w-3/4 h-2 bg-line rounded-full mb-2"></div>
                    <div className="w-1/2 h-2 bg-line rounded-full mb-4"></div>
                  ...
                  <div className="flex justify-end transform translate-x-8">
                    <div className="px-4 py-2 bg-ink text-white text-sm font-medium rounded-full shadow-lg flex items-center gap-2">
        ...
        <div className="mt-32 space-y-32">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
              <img 
                ...
                referrerPolicy="no-referrer"
              />
              <div className="absolute -bottom-6 -right-6 bg-surface p-4 rounded-2xl shadow-xl border border-line flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-ink-3">Text, Images & Video</div>
                </div>
              </div>
            </div>
            <div className="order-1 md:order-2 space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-ink-2">
                  <div className="w-6 h-6 rounded-full bg-ok-soft flex items-center justify-center text-ok">✓</div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-ink-2">
                  <div className="w-6 h-6 rounded-full bg-accent-soft flex items-center justify-center text-accent">✓</div>
            ...
            <div className="relative">
              <img 
                ...
                referrerPolicy="no-referrer"
              />
              <div className="absolute -top-6 -left-6 bg-surface p-4 rounded-2xl shadow-xl border border-line flex items-center gap-4">
                <div className="w-12 h-12 bg-accent-soft rounded-full flex items-center justify-center">
        ...
        <div className="mt-32">
          ...
          <div className="bg-surface p-8 rounded-2xl border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-sunk rounded-xl flex items-center justify-center mb-6">
              <LayoutDashboard className="w-6 h-6 text-ink-2" />
            </div>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-sunk rounded-xl flex items-center justify-center mb-6">
              <Edit3 className="w-6 h-6 text-ok" />
            </div>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-sunk rounded-xl flex items-center justify-center mb-6">
              <PenTool className="w-6 h-6 text-ink-2" />
            </div>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-sunk rounded-xl flex items-center justify-center mb-6">
              <Calendar className="w-6 h-6 text-ink-2" />
            </div>
